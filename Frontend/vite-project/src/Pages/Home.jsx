...
//   // FIXED: YouTube playback function
//   const playYouTubeSong = (videoName) => {
//     if (!videoName) return;

//     const cleaned = videoName
...
//         if (typeof getGeminiResponse !== "function") return;

//         const raw = await getGeminiResponse(transcript);
...
//         } catch (err) {
//           console.error("JSON Parse error:", err, rawString);
//           return;
//         }
...
//           // YOUTUBE PLAY
//           case "youtube_play":
//             speak(`Playing ${data.video} on YouTube`);
//             playYouTubeSong(data.video);
//             break;
...
//           case "get_time": {
//             // Safety: clear speaking queue
//             window.speechSynthesis.cancel();

//             // Always trust data.time first
//             const finalTime = data.time && data.time !== "..."
//               ? data.time
//               : (data.response || "not available");

//             speak(`The current time is ${finalTime}`);
//             break;
//           }

//           case "get_day":
//             speak(`Today is ${data.day}`);
//             break;

//           case "get_month":
//             speak(`Current month is ${data.month}`);
//             break;
...
//   return (
//     <div className="w-full min-h-screen bg-linear-to-t from-[black] to-[#020236] text-white py-12">
...
//               <p className="text-sm text-gray-300">I'm {assistantName}</p>
//             </div>
//           </div>
...
//             <section className="bg-white/3 rounded-lg p-6">
//               <h3 className="text-xl font-semibold mb-2">Overview</h3>
//               <p className="text-sm text-gray-200">
//                 Quick actions and insights about your assistant.
//               </p>
//               <div className="mt-4 flex flex-wrap gap-3">
//                 <button
//                   type="button"
//                   onClick={() => alert("Open chat (placeholder)")}
...
//             <div className="bg-gray-900 rounded-lg overflow-hidden shadow-lg md:sticky md:top-20">
//               {assistantImage ? (
//                 <img src={assistantImage} className="w-full h-64 object-cover" />
//               ) : (
...
//                   Personalize the appearance and name from Customize.
//                 </p>
//               </div>
//             </div>
//           </aside>
